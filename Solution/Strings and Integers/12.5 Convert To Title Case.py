def to_title_case(sentence: str) -> str:
    """Your function should take a string as an input and convert all the first letters of the words in the string
    ...
    return ' '.join(list(map(lambda x: x[0:1].upper() + x[1:], sentence.lower().split())))
